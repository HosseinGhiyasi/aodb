...
const flightModel = {
    ...
    updateFlight: async (flightNumber, updatedFlightData) => {
        ...
        try {
            ...
            request.input('DestinationAirportCode', sql.VarChar(3), updatedFlightData.DestinationAirportCode);
    ...
    getFlightsByRoute: async (departureCity, destinationCity) => {
        ...
        try {
            ...
            const result = await request.query('select * from getFlightsByRoute_fn(@DepartureCity,@DestinationCity)');
    ...
    searchFlight: async (departureCity, destinationCity, departureTime) => {
        ...
        try {
            ...
            const result = await request.query('select * from searchFlight(@DepartureCity,@DestinationCity,@DepartureTime)');
            if (result.recordset.length === 0) {
